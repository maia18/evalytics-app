...
# Limiares de classificação visual do desempenho (escala 0-5)
...
def TelaResultados(page: ft.Page) -> ft.Container:
    ...
    NOTA: a exportação de PDF (`exportar_pdf`) roda de forma síncrona e pode
    bloquear a interface durante a geração do gráfico/documento. Corrigir
    isso exigiria tornar o callback assíncrono; sinalizado, não alterado.
    """
    ...
    return ft.Container(
        ...
        content=ft.Column(
            ...
            controls=[
                ...
                ft.Column(expand=True, controls=cards_resultados),
            ],
        ),
    )