...
class FormularioRenderMixin:
    def atualizar_renderizacao(self):
        ...
        btn_avancar = ft.ElevatedButton("Finalizar" if eh_ultima_pergunta else "Avançar", icon=ft.Icons.CHECK if eh_ultima_pergunta else ft.Icons.ARROW_FORWARD, bgcolor="green" if eh_ultima_pergunta else "primary", color="white" if eh_ultima_pergunta else "onPrimary", on_click=self.avancar)
