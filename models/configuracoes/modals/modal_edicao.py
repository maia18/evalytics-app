...
def criar_modal_edicao(page: ft.Page, estado: EstadoIndicadores, abrir_pasta: Callable[[str], None]) -> tuple[ft.AlertDialog, ft.TextField, ft.TextField, Callable]:
    ...
    # Persiste as alterações de título e descrição do indicador no banco.
    def salvar_edicao(e: ft.ControlEvent) -> None:
        ...
        page.update()  # Atualiza a interface da lista para refletir o novo título imediatamente.
    ...
    # Prepara o estado, injeta os dados atuais nos campos e revela o popup.
