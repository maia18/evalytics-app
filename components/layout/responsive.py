...
class ResponsiveLayout:
    ...
    def _criar_topbar_content(self):
        ...
        icone_tema = ft.Icons.LIGHT_MODE_OUTLINED if self.dark_mode else ft.Icons.DARK_MODE_OUTLINED # Define se mostra a Lua (modo claro) ou Sol (modo escuro)
        
        local_atual = obter_localizacao() # Busca a localização real de forma automática no momento em que a Topbar é criada
