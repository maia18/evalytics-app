...
class Navigator:
    ...
    def go(self, rota: str):
        ...
        self.page.views.append(view(self.page, self.go)) # Adiciona a nova view à página, passando a referência da página e o método go (para permitir navegação interna)
