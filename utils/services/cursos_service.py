...
ATENÇÃO ARQUITETURAL: 
    Esta constante aponta para a coleção "cursos" do Firestore, mas espera um formato de documento diferente (nome/modalidade/ativo) do outro arquivo de cursos do sistema. 
